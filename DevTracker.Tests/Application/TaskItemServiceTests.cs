...
public class TaskItemServiceTests
{
    ...
    public async Task CreateTaskItem_WithEmptyString_ExpectExceptionThrown()
    {
        ...
        //Act
        //Assert
        await Assert.ThrowsAsync<ArgumentNullException>(() => _taskItemServiceMock.CreateTaskItemAsync(taskItemTitle));
    }
    ...
    public async Task CreateTaskItem_WithString_ExpectSuccessAsync()
    {
        ...
        //Act
        var result = await _taskItemServiceMock.CreateTaskItemAsync(taskItemTitle);
        //Assert
        Assert.True(result);
    }
}
